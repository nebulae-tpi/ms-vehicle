...
![Intro](docs/images/ms-vehicle_intro.png "Intro")
# Table of Contents
  ...
  * [BackEnd](#backend)
    *  [vehicle](#backend_vehicle)
        * [Environment variables](#backend_vehicle_env_vars)
        * [Event Sourcing](#backend_vehicle_eventsourcing)
        * [CronJobs](#backend_vehicle_cronjobs)
...
## vehicle <a name="backend_vehicle"></a>
...


### Environment variables <a name="backend_vehicle_env_vars"></a>
...
```
#### Notes: 
  * ENV VARS for development are [here](backend/vehicle/.env)
  * ENV VARS for production are [here](deployment/gke/deployment-vehicle.yaml)

### Event Sourcing <a name="backend_vehicle_eventsourcing"></a>
