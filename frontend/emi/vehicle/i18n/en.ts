    ...
    VEHICLE: {
      ...
      BLOCKS: {
        ...
        TYPES: {
          ...
          PICO_Y_PLACA: 'License Plate Restriction',
          OTHER: 'Other'
        },
      },
      SUBSCRIPTION: {
        STATE_TITLE_LBL: 'Subscription State',
        TRANSFER_TIME: 'Transfer subscription',
        MISSING: 'Vehicle Without Subscription',
